...
plot(IMU.t,rawIMU.pos(1,:),'Color','#CC5500','LineWidth',2,'LineStyle','--')
title('Dead Reckoned Position')
ylabel('x [m]')
xlim([0 GPS.t(end)])
legend('Simulated GPS','Truth','Mechanized IMU','Location','eastoutside')
ax = gca;
ax.FontSize = 18;
nexttile
hold on
...
plot(IMU.t,rawIMU.pos(2,:),'Color','#CC5500','LineWidth',2,'LineStyle','--')
ylabel('y [m]')
xlim([0 GPS.t(end)])
ax = gca;
ax.FontSize = 18;
...
plot(IMU.t,rawIMU.pos(3,:),'Color','#CC5500','LineWidth',2,'LineStyle','--')
xlabel('Time [s]')
ylabel('z [m]')
xlim([0 GPS.t(end)])
ax = gca;
...
plot(IMU.t,rawIMU.vel(1,:),'Color','#CC5500','LineWidth',2,'LineStyle','--')
...
plot(IMU.t,rawIMU.vel(2,:),'Color','#CC5500','LineWidth',2,'LineStyle','--')
ylabel('v_y [m/s]')
xlim([0 GPS.t(end)])
ax = gca;
ax.FontSize = 18;
...
plot(IMU.t,rawIMU.vel(3,:),'Color','#CC5500','LineWidth',2,'LineStyle','--')
xlabel('Time [s]')
ylabel('v_z [m/s]')
xlim([0 GPS.t(end)])
ax = gca;
...
% nexttile
% hold on
% plot(IMU.t,rad2deg(rawIMU.eul(1,:)),'Color','#CC5500','LineWidth',2)
...
% nexttile
% hold on
% plot(IMU.t,rad2deg(rawIMU.eul(2,:)),'Color','#CC5500','LineWidth',2)
...
% nexttile
% hold on
% plot(IMU.t,rad2deg(rawIMU.eul(3,:)),'Color','#CC5500','LineWidth',2)
